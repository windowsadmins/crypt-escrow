...
2. **Configure Crypt Server URL:**
   The pkgsinfo files are pre-configured with: `https://crypt.example.com`
...
```powershell
# Test escrow
checkin escrow --server https://crypt.example.com

# Test verification
checkin verify --server https://crypt.example.com

# Test rotation
checkin rotate --server https://crypt.example.com
